...
class LadaApplication(Adw.Application):
    ...
    def do_activate(self):
        ...
        if not win:
            ...
            self.bind_property("style-manager", win.realtime_view.widget_timeline, "style-manager", flags=GObject.BindingFlags.SYNC_CREATE)
            self.bind_property("shortcuts-manager", win.realtime_view, "shortcuts-manager", flags=GObject.BindingFlags.SYNC_CREATE)
            self.bind_property("config", win.realtime_view, "config", flags=GObject.BindingFlags.SYNC_CREATE)
